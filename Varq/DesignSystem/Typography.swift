...
enum VarqLayout {
    ...
    static let readingAssistantSidebarMinimumWidth: CGFloat = 320
    static let readingAssistantSidebarIdealWidth: CGFloat = 360
    static let readingAssistantSidebarMaximumWidth: CGFloat = 440
